...
typedef EA::Genetic<RotationTranslation, RotationTranslationCost>
    GA_Rot_Trans_t;
...
class Optimiser 
{
  ...
  bool optimise(RotationTranslation& opt_result,
                std::vector<OptimisationSample>& set, cv::Mat& cameramat,
                cv::Mat& distcoeff);

  void generate_sets(int offset, int k, std::vector<OptimisationSample>& set,
  ...
  Rotation crossover(const Rotation& X1, const Rotation& X2,
  ...
  RotationTranslation crossover(const RotationTranslation& X1,
  ...
  void init_genes(RotationTranslation& p,
                  const std::function<double(void)>& rnd01,
                  const RotationTranslation& initial_rotation_translation,
                  double angle_increment, double translation_increment);
