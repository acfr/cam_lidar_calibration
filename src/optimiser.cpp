...
bool Optimiser::optimise(RotationTranslation& opt_result, std::vector<OptimisationSample>& set, cv::Mat& cameramat,
                         cv::Mat& distcoeff)
{
  ...
  printf("| % 05.3f,% 05.3f,% 05.3f,% 05.3f,% 05.3f,% 05.3f ", opt_result.rot.roll, opt_result.rot.pitch,
